      ...
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900">
            {isSpanish ? 'Ya depositaste hoy.' : 'Already deposited today.'}
          </h2>
    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2">
            {isSpanish ? 'Tu portafolio crece.' : 'Your portfolio grows.'}
          </p>
        </div>
      </div>
    );
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-gray-300 text-sm mb-4">
            {isSpanish
              ? 'Estudios pagados aparecen aqui cuando BioCycle alcance 500 inversores activos. Tus depositos diarios construyen la base.'
              : 'Paid studies appear here when BioCycle reaches 500 active investors. Your daily deposits are building the foundation.'}
          </p>
