...
exports.handler = async (event) => {
  ...
  try {
    ...
    // ── Compatibility invite response (YES / NO typed text) ───────────────
    // Acceptance/rejection for compatibility invites is handled in-app.
    // These handlers remain for the reminder opt-in flow (not compatibility).
